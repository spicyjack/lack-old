package AntBuild::Archive::Zip;
# Copyright (c)2006 Brian Manning ( elspicyjack at gmail dot com )
# $Id: Zip.pm,v 1.3 2006-08-19 07:38:25 brian Exp $

=pod

=head1 NAME

AntBuild::Archive::Zip

=head1 DESCRIPTION

=head2 Overview

B<AntBuild::Archive::Zip> is a set of common methods for working with
...
$VERSION=1.00;
#$VC_VERSION=q($Revision: 1.3 $ $Date: 2006-08-19 07:38:25 $);
use strict;
use warnings;
use AntBuild::Tools 1.00;
@AntBuild::Archive::Zip::ISA = qw(AntBuild::Tools);
...
sub new {
    ...
    $this->set_zippath( $args{zippath} || q(/usr/bin/zip) );
